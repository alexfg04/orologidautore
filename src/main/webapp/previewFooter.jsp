...
<div class="process-container">
    <div class="process-step">
        ...
        <div class="step-icon">
            <img src="assets/img/orolo.png" alt="Trova orologio" style="width: 60px; height: 60px; object-fit: cover;">
        </div>
        <div class="step-text">Trova l'orologio che fa per te</div>
    </div>
    <div class="process-step">
        <div class="step-number">2.</div>
        <div class="step-icon">
            <img src="assets/img/cassa.png" alt="Paga sicuro" style="width: 60px; height: 60px; object-fit: cover;">
        </div>
        <div class="step-text">Paga in modo sicuro tramite un conto di deposito a garanzia</div>
    </div>
    <div class="process-step">
        <div class="step-number">3.</div>
        <div class="step-icon">
            <img src="assets/img/casa.png" alt="Ricevi orologio" style="width: 60px; height: 60px; object-fit: cover;">
        </div>
        <div class="step-text">Ricevi il tuo nuovo orologio</div>
    </div>
    <div class="process-step">
        <div class="step-number">4.</div>
        <div class="step-icon">
            <img src="assets/img/pagamento.png" alt="Pagamento venditore" style="width: 60px; height: 60px; object-fit: cover;">
        </div>
