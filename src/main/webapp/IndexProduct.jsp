...
<div class="container-product">
    ...
    <a href="${pageContext.request.contextPath}/product?id=7" class="card">
        <img src="https://www.watchshop.com/images/products/75552869_l.jpg" alt="Orologio 1">
        <div class="container-text">
            <h3>Orologio Classico</h3>
            <p>Elegante orologio da polso in pelle</p>
        </div>
    ...
    <a href="${pageContext.request.contextPath}/product?id=15" class="card">
        <img src="https://www.watchshop.com/images/products/39912803_l.jpg" alt="Orologio 2">
        <div class="container-text">
            <h3>Orologio Sportivo</h3>
            <p>Design moderno e resistente all’acqua</p>
        </div>
