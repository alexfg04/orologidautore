<div class="container-product">
    ...
    <a href="catalog.jsp" class="card">
        ...
        <div class="container-text">
            ...
            <p>Design accattivante per chi ama lo sport</p>
        </div>
    </a>
    ...
    <a href="catalog.jsp" class="card">
        ...
        <div class="container-text">
            ...
            <p>Orologio per chi ama l'eleganza e la contemporaneita'</p>
        </div>
    </a>
    ...
    <a href="catalog.jsp" class="card">
        ...
        <div class="container-text">
            ...
            <p>Per i clienti piu' delicati e sofisticati</p>
        </div>
    </a>
</div>
<div class="container-product">
    ...
    <a href="catalog.jsp" class="card">
        ...
        <div class="container-text">
            ...
            <p>I vecchi del passato, sempre di moda</p>
        </div>
    </a>
    ...
    <a href="catalog.jsp" class="card">
        ...
        <div class="container-text">
            ...
            <p>I piu' desiderati. I piu' amati. I piu' desiderati.</p>
        </div>
    </a>
    ...
    <a href="catalog.jsp" class="card">
        ...
        <div class="container-text">
            ...
            <p>Per chi ha un budget limitato</p>
        </div>
    </a>
    ...
    <a href="catalog.jsp" class="card">
        ...
        <div class="container-text">
            ...
            <p>Per chi ama distinguersi e farsi riconoscere,un classico</p>
        </div>
    </a>
</div>
